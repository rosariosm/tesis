...
\newcommand{\tituloTrabajo}{Adaptación de CodeCombat para la enseñanza de Python en la escuela secundaria}
% \tituloTrabajoDosLineas :: Para escribir el título de la tesina en dos líneas (carátula)
\newcommand{\tituloTrabajoDosLineas}{Adaptación de CodeCombat \\* para la enseñanza de Python en la escuela secundaria}
...
\newcommand{\caratula}{
  \begin{center}
    ...
    \vspace{10mm}
    \large{\textbf{\santamarinar}}\\
    \vspace{20mm}
    \large{Directoras: Banchoff Tzancoff, Claudia y Fava, Laura}\\
    \vspace{20mm}
